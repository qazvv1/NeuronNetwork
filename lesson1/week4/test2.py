...
# np.save("para",parameters)


###### predict ###########
paramenters = np.load("para.npy", allow_pickle=True).item()
...
# my_image = transform.resize(image, 
#     (num_px, num_px)).reshape((num_px*num_px*3, 1))
# my_image = my_image/255.
# my_predicted_image = predict(my_image, my_label_y, paramenters)
...
train_x_1 = train_x[:, n].reshape(train_x.shape[0], 1)

train_y_1 = train_y[0, n].reshape(1,1)

predict_1 = predict(train_x_1, train_y_1, paramenters)
